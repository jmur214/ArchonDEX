...
- [Live paper-path audit near-misses (2026-09-17)](project_live_paper_path_audit_2026_09_17.md) — wash guard UNFED (per-prefix lots, acct-1 never records); cash-drift halt dead while holding; no price collar; journal durable only at exit.
