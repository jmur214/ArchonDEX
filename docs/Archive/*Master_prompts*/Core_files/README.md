...
*   `run_shadow_paper.py`: Orchestrates the Phase 2 Shadow Trading Loop (Hunter + Shadow Broker).
...
*   `update_data.py`: Managed data updater (Fundamental + Intraday) using universe.json.
