...
class AutogenPhase3Short(EdgeBase, EdgeTemplate):
    ...
    def set_params(self, params=None):
        ...
        # (default matches the hardcoded short direction); fixed for the class.
