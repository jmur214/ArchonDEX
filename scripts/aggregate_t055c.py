"""T-2026-05-22-055c aggregation — read per-arm incremental JSON,
compute headline + per-year tables with bootstrap CI.

Reads:
  data/measurements/vol_target_t055c_2026_05_22/arm0_results.json
  data/measurements/vol_target_t055c_2026_05_22/arm1_results.json

Writes:
  docs/Audit/engine_b_vol_targeting_ab_t055c_2026_05_22.json
  docs/Audit/engine_b_vol_targeting_ab_t055c_2026_05_22.md (audit doc)
...
AUDIT_JSON = ROOT / "docs" / "Audit" / "engine_b_vol_targeting_ab_t055c_2026_05_22.json"
AUDIT_MD = ROOT / "docs" / "Audit" / "engine_b_vol_targeting_ab_t055c_2026_05_22.md"
...
def main() -> int:
    ...
    payload = {
        "task_id": "T-2026-05-22-055c",
        "description": "Engine B vol-targeting A/B lift verification (3-rep × 5-yr × 2-arm)",
        "n_backtests": {
            "arm0_off": n_arm0,
            "arm1_on": n_arm1,
            "total": n_arm0 + n_arm1,
