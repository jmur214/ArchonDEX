"""T-2026-05-23-055e aggregation — read per-arm incremental JSON,
compute headline + per-year tables with bootstrap CI.

Reads:
  data/measurements/vol_target_regime_t055e_2026_05_23/arm0_results.json
  data/measurements/vol_target_regime_t055e_2026_05_23/arm1_results.json

Writes:
  docs/Audit/engine_b_vol_target_regime_conditional_t055e_2026_05_23.json

Mirrors scripts/aggregate_t055d.py structure for direct comparability.
"""
...
AUDIT_JSON = ROOT / "docs" / "Audit" / "engine_b_vol_target_regime_conditional_t055e_2026_05_23.json"
...
def main() -> int:
    ...
    payload = {
        "task_id": "T-2026-05-23-055e",
        "description": "Engine B vol-target regime-conditional (EWMA + regime_aware) A/B lift verification",
        "n_backtests": {
            "arm0_off": n_arm0,
            "arm1_on": n_arm1,
            "total": n_arm0 + n_arm1,
    ...
    print(f"[T-055E] aggregation written → {AUDIT_JSON}")
