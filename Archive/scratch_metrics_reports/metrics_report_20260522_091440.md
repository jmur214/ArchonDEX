---
title: Metrics report — 1 run(s) under T-059..T-065 suite
date: 2026-05-22
author: scripts/metrics_report.py (T-2026-05-22-069)
---

# Metrics report — 1 run(s) under T-059..T-065 suite

## Per-run breakdown

| Label | Sharpe_naive | Sharpe_Lo | Lo_η | Lo_haircut | ES_97.5% | MDD% | CDaR_95% | Rolling-PSR | CUSUM alarm |
|-------|--------------|-----------|------|------------|----------|------|----------|-------------|-------------|
| 2021_rep1 | +1.791 | +1.586 | 14.06 | +11.5% | -0.79% | -2.67% | -1.54% | 0.627 | — |
